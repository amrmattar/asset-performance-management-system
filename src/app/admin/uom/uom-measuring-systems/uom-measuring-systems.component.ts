...
@Component({
  selector: 'app-uom-measuring-systems',
  templateUrl: './uom-measuring-systems.component.html',
  styleUrls: ['./uom-measuring-systems.component.scss']
})
export class UomMeasuringSystemsComponent implements OnInit {
